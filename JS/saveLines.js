...
function saveLineValues()
{
   ...
   for (i = 0; i < allTr.length; i++)
   {
      ...
      obj.data = allTr[i].children[2].children[0].value
      obj.t1 = allTr[i].children[3].children[0].value
      obj.t2 = allTr[i].children[4].children[0].value
      obj.t3 = allTr[i].children[5].children[0].value
      obj.t4 = allTr[i].children[6].children[0].value
      obj.total = allTr[i].children[7].children[0].value
